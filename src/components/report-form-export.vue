  ...
  <div id="Main">
    ...
    <div class="box" style="margin-top: 15px;padding-bottom:20px">
      <div class="contentTop">
        <Button
          @click="displayRegUserTrackStatisticsExport"
          icon="ios-download-outline"
          type="primary"
        >注册用户统计</Button>
        <Button
          @click="displayApplyUserTrackStatisticsExport"
          icon="ios-download-outline"
          type="primary"
        >申请陈列用户统计</Button>
        ...
        <Button
          @click="displayRegUserTrackDetailExport"
          icon="ios-download-outline"
          type="primary"
        >客户注册明细</Button>
        <Button
          @click="displayApplyUserTrackDetailExport"
          icon="ios-download-outline"
          type="primary"
        >已申请陈列明细</Button>
        <Button
          @click="displayUploadRecordTrackDetailExport"
          icon="ios-download-outline"
          type="primary"
        >已上传陈列视频审核明细</Button>
      </div>
      <div>
        ...
        <Button
          @click="displayJoinGoodsRecordTrackDetailExport"
          icon="ios-download-outline"
          type="primary"
        >进货量明细</Button>
      </div>
  ...
  methods: {
    displayRegUserTrackStatisticsExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayRegUserTrackStatisticsExport.json",
        data
      );
      window.open(url);
    },
    displayApplyUserTrackStatisticsExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayApplyUserTrackStatisticsExport.json",
        data
      );
      window.open(url);
    },
    handleClick(name) {
      ...
      var url = this.Global.getExportUrl(
        "report/displayUploadUserTrackStatisticsExport.json",
        data
      );
      window.open(url);
    },
    displayRegUserTrackDetailExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayRegUserTrackDetailExport.json",
        data
      );
      window.open(url);
    },
    displayApplyUserTrackDetailExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayApplyUserTrackDetailExport.json",
        data
      );
      window.open(url);
    },
    displayUploadRecordTrackDetailExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayUploadRecordTrackDetailExport.json",
        data
      );
      window.open(url);
    },
    displayUploadUserTrackStatisticsForMonthExport(name) {
      ...
      var url = this.Global.getExportUrl(
        "report/displayUploadUserTrackStatisticsForMonthExport.json",
        data
      );
      window.open(url);
    },
    displayJoinGoodsRecordTrackDetailExport() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayJoinGoodsRecordTrackDetailExport.json",
        data
      );
      window.open(url);
    }
