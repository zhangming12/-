...
export default {
    ...
    mounted: function(){
        ...
        //     this.formData.createTime = that.Global.createTime(this.$route.query.params.createTime)
        // }
    },
    beforeRouteEnter(to, from, next) {
        ...
        if(to.path == '/awardStatusTracking-edit'){
            next(vm => {
                ...
                vm.formData.createTime = vm.Global.createTime(to.query.params.createTime);//时间
                vm.formData.recStatus = vm.Global.ENUMS.harvestStauts[to.query.params.recStatus]
            })
