<style lang="less" scoped>
    ...
    .ivu-table-row{
        box-shadow: 0 0 5px 2px rgba(114, 69, 69, 0.1)!important;
...
export default {
    name:"electron-award-manage-keepAlive",
    data () {
        const that = this;
                             ...
                             h('Button', {
                                ...
                                on: {
                                    click: () => {
                                        ...
                                        // window.open(location.origin + location.pathname + '#' +'/realyAwardManage-edit?type=edd&id='+params.row.id)
                                        
                                        this.$router.push({path:'/realyAwardManage-edit',query:{type:'edd',id:params.row.id}})
                                    }
                                }
                            }, '修改'),
                            // h('Button',{
