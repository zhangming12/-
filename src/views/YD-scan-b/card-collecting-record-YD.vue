    ...
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          tooltip: true,
          render: (h, params) => {
            if (params.row.collectTime)
              return h("div", this.Global.createTime(params.row.collectTime));
          }
        }
      ],
      pageSize: 10,
  ...
  methods: {
    ...
    exportExcel() {
      ...
      var url = this.Global.getExportUrl(
        "collect/collectCardsExport.json",
        data
      );
      window.open(url);
    },
    init() {
      ...
      this.Global.deleteEmptyProperty(data);
      this.Global.doPost("collect/collectCardsByStore.json", data, res => {
