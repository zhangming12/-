...
export default {
  name:"salesman-next-keepAlive",
    ...
    data() {
        ...
        return {
            ...
            columns1: [
                ...
                //                             content: '确定删除该业务员？',
                //                             onOk: function(){
                //                                 that.userBlack(params.row.brandId,params.row.workerId)
                //                             }
                //                         })
                //                     }
                //                 }
    ...
    methods: {
        ...
        userBlack: function(brandId,workerId){
            var that = this;
            this.Global.doPost('worker/updateStatus.json',{
                brandId: brandId,
                workerId: workerId
            },function(){
        ...
        init: function() {
            ...
            data['brandId'] = that.activityData.brandId;//品牌
            data['activityId'] = that.activityData.id;//活动
            this.Global.doPost('worker/queryWorkerList.json', data, function(res) {
        ...
        dowland: function(){// 业务员模版
            window.open('https://hbrand.oss-cn-hangzhou.aliyuncs.com/demo/workerInfo(%E5%93%81%E7%89%8C%E4%B8%9A%E5%8A%A1%E5%91%98%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF).xlsx')
        },
