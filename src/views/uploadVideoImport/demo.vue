...
export default {
  data() {
    return {
      time: [],
      // times: Date.now() - 86400000,
      options: {
        disabledDate(date) {
          console.log("data");
          console.log(date);
          return (
            (date && date.valueOf() < Date.now() - 864000000) ||
            (date && date.valueOf() > Date.now() + 864000000)
          );
        }
      },
      ...
      columns1: [
        {
          ...
          minWidth: 120,
          render: (h, params) => {
            if (params.row.activityName == "total") {
              return h(
                "div",
                {
                  style: {
              ...
              return h("div", params.row.activityName);
            }
          }
        },
        {
