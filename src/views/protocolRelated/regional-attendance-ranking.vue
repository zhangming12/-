            ...
            <div id="fourLevel" v-if="formData.threeLevel">
              ...
              <ul>
                <li>
                  ...
                  <span>三级组织</span>
                  <span>四级组织</span>
                  <span @click="orderType = 'signNum'" class="sort">
                    签约数
                    <Icon
                      class="icon"
                      type="ios-funnel"
                      :color="orderType == 'signNum'?'#ff9900':'#17233d'"
                    ></Icon>
                  </span>
                  <span @click="orderType = 'passNum'" class="sort">
                    通过数
                    <Icon
                      class="icon"
                      type="ios-funnel"
                      :color="orderType == 'passNum'?'#ff9900':'#17233d'"
                    ></Icon>
                  </span>
                </li>
...
export default {
  ...
  methods: {
    ...
    init(sort) {
      ...
      this.Global.doPost("uploadReport/queryAreaSignList.json", data, res => {
