                    ...
                    <div id="fourLevel"  v-if="formData.threeLevel">
                      ...
                      <ul>
                          <li>
                              ...
                              <span>三级组织</span>
                              <span>四级组织</span>
                              <span @click="orderType = 'signNum'" class="sort">签约数<Icon class="icon" type="ios-funnel" :color="orderType == 'signNum'?'#ff9900':'#17233d'"></Icon></span>
                              <span @click="orderType = 'passNum'" class="sort">通过数<Icon class="icon" type="ios-funnel" :color="orderType == 'passNum'?'#ff9900':'#17233d'"></Icon></span>
                          </li>
...
export default {
  name:"regional-attendance-ranking-keepAlive",
  data() {
    ...
    return {
      ...
      orderType: 'signNum', //signNum,按签约数排序，passNum,按通过数排序
      rule: {
      },
      pageData: [],
      columns: [
  ...
  methods: {
    ...
    init(sort) {
      ...
      this.Global.doPost(
        "uploadReport/queryAreaSignList.json",
        data,
        res => {
          this.fourLevelData = res.datalist;
        }
      );
    },
    exportExcel() {
      ...
      var url = this.Global.getExportUrl(
        "uploadReport/areaSignListExport.json",
        data
      );
      window.open(url);
    },
