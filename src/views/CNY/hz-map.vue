...
<template>
  <div >
    <div class="box">
        <div class="iconBox">
            <router-link to='/hzMapBig' v-if="bigStatus">
                <Icon type="ios-expand" size="22" color="red" class='small '></Icon>
            </router-link>
            <router-link to='/hzMap' v-else>
...
import hangzhou from "@/assets/330100.json";
export default {
  data() {
    return {
      bigStatus: true,
  ...
  methods: {
    drawLine(geoCoordMap = {}, data = []) {
      geoCoordMap["富阳市"] = [119.95, 30.05];
      geoCoordMap["拱墅区"] = [120.13, 30.32];
      geoCoordMap["滨江区"] = [120.2, 30.2];

      geoCoordMap["淳安县"] = [119.03, 29.6];
      geoCoordMap["建德市"] = [119.28, 29.48];
      geoCoordMap["江干区"] = [120.2, 30.27];
      geoCoordMap["临安市"] = [119.72, 30.23];
      geoCoordMap["上城区"] = [120.17, 30.25];
      geoCoordMap["桐庐县"] = [119.67, 29.8];
      geoCoordMap["西湖区"] = [120.13, 30.27];
      geoCoordMap["下城区"] = [120.17, 30.28];
      geoCoordMap["萧山区"] = [120.27, 30.17];
      geoCoordMap["余杭区"] = [120.3, 30.42];

      data.push(
        { name: "富阳市", value: 480, value1: 1 },
        { name: "余杭区", value: 480, value1: 1 },
        { name: "萧山区", value: 480, value1: 1 },
        { name: "下城区", value: 480, value1: 1 },

        { name: "西湖区", value: 480, value1: 1 },
        { name: "拱墅区", value: 480, value1: 1 },
        { name: "滨江区", value: 480, value1: 1 },
        { name: "黄埔区", value: 480, value1: 1 },
        { name: "桐庐县", value: 480, value1: 1 },

        { name: "上城区", value: 480, value1: 1 },
        { name: "临安市", value: 480, value1: 1 },
        { name: "江干区", value: 480, value1: 1 },
        { name: "建德市", value: 480, value1: 1 },
        { name: "淳安县", value: 480, value1: 1 }
      );
        ...
        res => {
          ...
          if (dataList && dataList.length) {
            dataList.forEach(item => {
              let signLocate = item.signLocate.split(",").reverse();
              signLocate[0] = Number(signLocate[0]);
              signLocate[1] = Number(signLocate[1]);
              geoCoordMap[item.signName] = signLocate;
              let obj = {};
              let signName = item.signName;
              obj["name"] = item.signName;
              obj["value1"] = 1; //计划签到   1已签到 0未签到
              obj["value2"] = item.peopleNum; //实际签到
              arrList.push(obj);
            });
          }
