        ...
        <Row>
          <Col span="8">
            <Form-item label="品牌名称:" prop="brandId" required>
              <Select
                ...
                placeholder="请选择"
                :disabled="type == 'look' || type == 'modify'"
                @on-change="newChangeValue"
              >
                <Option
                  :value="item.id"
                  v-for="(item,index) in brandList"
          ...
          <Col span="8">
            ...
            <Form-item label="流水线:" prop="pipeLine">
              <i-input
                v-model.trim="formItem.pipeLine"
                placeholder="请输入流水线"
                :readonly="type == 'look'"
              ></i-input>
            </Form-item>
