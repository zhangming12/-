        ...
        <div class="table-box box">
            <div class="contentTop">
              <span class="btn-left">
                ...
                ：已印刷码包数
                <span class='numColor'>{{pageNum}}</span>，已印刷码量
      ...
      <!-- 导入导出历史 -->
       <myModal class="myModal"
          ...
          <div slot="main" class="modal-main">
            ...
            <Form ref="form" :model="formData" :label-width="10" :rules="rule">
              <div class="container">
                ...
                <Form-item label="已印刷码包：" :label-width="100"  required>
        ...
        <myModal class="myModal"
            ...
            :modal="modifyMemo">
          <div slot="main" class="modal-main">
            <h3 style="margin-bottom:10px;">修改印刷备注</h3>

            <Form ref="form" :model="formData" :label-width="10" :rules="rule">
              <div class="container">
                <Form-item label="印刷备注：" :label-width="100">
                  <Input v-model="memo" placeholder="请输入印刷备注" /> 
                </Form-item>
              </div>
            </Form>
            <div class="maintain-footer">
        ...
        <myModal class="myModal"
          ...
          <div slot="main" class="modal-main">
            <h3 style="margin-bottom:10px;">印刷报废数</h3>
...
export default {
  name:"code-printing-and-scrap-keepAlive",
  data() {
    const that = this;
                  ...
                  on: {
                    click: () => {
                      ...
                      this.Global.doPostNoLoading(
                        "codepackage/queryPrintAndScrapFactory.json",
                        {
                          packageNo: params.row.packageNo,
                          brandId: this.formData.brandId
                        },
                        res => {
                          this.paintScrapeData = res.datalist;
  ...
  methods: {
    ...
    modifyMemos() {
      ...
      data["memo"] = this.memo;
      data["id"] = this.id;
      this.Global.doPostNoLoading("codepackage/updataMemo.json", data, res => {
        this.$Message.success("修改成功");
    ...
    uploadExcel() {
      ...
      this.Global.doPost(
        "codepackage/printAndScrapImport.json",
        {
    ...
    dowland() {
      // 业务员模版
      window.open(
        "https://hbrand.oss-cn-hangzhou.aliyuncs.com/template/qr_code_print_template.xlsx"
      );
    },
    submit(name) {
    ...
    init(currentPage, pageSize) {
      ...
      this.Global.doPost("codepackage/scancodeallrecord.json", data, res => {
    ...
    exportExcel() {
      ...
      var url = this.Global.getExportUrl(
        "codepackage/scanCodeAllRecordExport.json",
        data
      );
      window.open(url);
    },
