                      ...
                      <Row>
                        ...
                        <Col span="9" offset="1">
                            <Form-item label="品牌名称" prop="brandId" required>
                                <Select v-model="formData.brandId" placeholder="请选择" @on-change="changeValue" disabled>
                      ...
                      <Row>
                        ...
                        <Col span="8">
                            ...
                            <Form-item label="销售大区" prop="regionName">
                                <Select v-model="formData.regionName" placeholder="请选择销售大区" @on-change="areaChangeValue" clearable>
                                    <Option :value="item.regionName" v-for="(item,index) in regionNameList" :key="index">{{ item.regionName }}</Option>
                                </Select>  
                            </Form-item>
                    ...
                    <Col span='7'>
                      <Form-item label="办事处" prop="officeName">
                          <Select v-model="formData.officeName" placeholder="请选择办事处" clearable>
                              <Option :value="item.officeName" v-for="(item,index) in officeNameList" :key="index">{{ item.officeName }}</Option>
                          </Select>  
                      </Form-item>
...
// import { getofficename } from "@api/common.js";
export default {
  ...
  data() {
    ...
    return {
      ...
      rule: {
        ...
        // groupId:[{required,message:"活动包不能为空"}]
