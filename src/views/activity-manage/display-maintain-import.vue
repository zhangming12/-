...
<template>
    ...
    <div style="margin: 10px;overflow: hidden">
      <div style="float: right;">
        ...
        <Modal
          v-model="importShow">
          <h2 style="text-align:center;margin-bottom:10px;">陈列活动维护导入</h2>
          <i-Form>
...
export default {
  name:"display-maintain-import-keepAlive",
  data() {
    return {
      importShow: false,
      showQuery: false,
  ...
  methods: {
    ...
    modify(val) {
      ...
      this.modifyData.startTime = val.showStartTime;
      this.modifyData.endTime = val.showEndTime;
    ...
    getActivityList(value) {
      this.activityList = [];
      this.Global.doPost(
        "displayYxtg/queryDisplayYxtgActivityList.json",
        { groupId: value },
        res => {
