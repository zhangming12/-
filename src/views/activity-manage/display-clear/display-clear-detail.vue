                ...
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="稽查状态：">
                            ...
                            <Select v-if="status == 2"  v-model="formData.checkStatus" clearable>
                                <Option v-for="(item, index) in checkStatusList" :value="item.id" :key="index">{{ item.name }}</Option>
                            </Select>
                        </FormItem>                                                              
                    </Col>
                    <Col span="6"  >
                    ...
                    <Col span="6"  >
                        <FormItem label="综合判定状态：" :label-width="100"> 
                            <span v-if="status == 1" class="txt">{{formData.auditCountQualified | auditCountQualified}}</span>
                            <Select v-if="status == 2" v-model="formData.auditCountQualified" clearable>
                                <Option v-for="(item, index) in auditCountQualifiedList" :value="item.id" :key="index">{{ item.name }}</Option>
                            </Select>
                        </FormItem>                    
                    </Col>                            
                </Row>
                ...
                <Row>
                    <Col>
                        <FormItem label="备注信息：" style="width: 100%;">
                            ...
                            <Input v-if="status == 2" v-model="formData.memo" type="textarea" :autosize="{minRows: 5,maxRows: 10}" ></Input>
                        </FormItem>
                    </Col>
                </Row>     
          </Form>
