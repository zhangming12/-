				...
				<Row>
					...
					<Form-item label="上传时间:">
						<Row>
							<Col span="11">
							<Form-item>
								<Date-picker type="datetime" placeholder="选择日期" v-model="formData.queryStartTime"></Date-picker>
							</Form-item>
							</Col>
							<Col span="2" style="text-align:center"> 至 </Col>
							<Col span="11">
							<Form-item>
								<Date-picker type="datetime" placeholder="选择日期" v-model="formData.queryEndTime" @on-change='dataChange'></Date-picker>
							</Form-item>
							</Col>
						</Row>
					</Form-item>
		...
		<Modal v-model="showVideoPlay" :width=800>
            <div>
                <Form :label-width="85" label-position="left">
                  <Row>
                    ...
                    <Col span="14" offset='1'>
                      ...
                      <Form-item label="客户状态:">
                        {{tableData.salesRoute}}
                      </Form-item>
                    </Col>
                  </Row>
                  <Form-item label="地址:" :label-width="50">
                    {{tableData.address}}
                  </Form-item>
                  <Row>
                    <Col span="8" offset='1'>
                  ...
                  <Form-item label="业代手机:">
                    {{tableData.workerPhone}}
                  </Form-item>
                  <Row>
                    <Col span="8" offset='1'>
                      <Form-item label="陈列活动:">
                        {{tableData.activityName}}
                      </Form-item>
                      <Form-item label="上传时间:">
                        {{tableData.createTime}}
                      </Form-item>
                      <Form-item label="合格情况:" :label-width="120">
                        {{tableData.salesRoute}}
                      </Form-item>
                      <Form-item label="进货达标情况:" :label-width="120">
                        {{tableData.salesRoute}}
                      </Form-item>
                      <Form-item label="标准费用:">
                        {{tableData.salesRoute}}
                      </Form-item>
                      <Form-item label="清算状态:">
                        {{tableData.salesRoute}}
                      </Form-item>
                    ...
                    <Col span="14" offset='1'>
                      <Form-item label="分组名称:">
                        {{tableData.presentName}}
                      </Form-item>
                      <Form-item label="结算周期:">
                        {{tableData.presentName}}
                      </Form-item>
                      <Form-item label="稽查状态:">
                        {{tableData.presentName}}
                      </Form-item>
                      <Form-item label="综合判定状态:" :label-width="120">
                        {{tableData.presentName}}
                      </Form-item>
                  ...
                  <Form-item label="备注:" :label-width='50'>
                    <Input v-model="tableData.memo" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入备注"></Input>
                  </Form-item>
                </Form>
