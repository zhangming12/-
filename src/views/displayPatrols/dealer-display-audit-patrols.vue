                  ...
                  <div class="content-box">
                    <Row style="width:100%;">
                      <Col span="8">
                        ...
                        <div class="item-box">
                          <span>审核状态：</span>
                          <span :class="item.checkStatus == 1? 'warnColor' :''">未审核</span>
                        </div>
                      </Col>
                      <Col span="8">
                        <div class="item-box">
    ...
    >
      ...
      <div>
        <Form :model="riskData" :label-width="90">
          <FormItem label="门店ID:">{{ joinCodeList.join() }}</FormItem>
          <FormItem label="风险类型:">
  ...
  methods: {
    ...
    riskShow() {
      ...
      if (!this.social.length) {
        this.$Message.info("请选择需要批量预警的视频");
        return false;
      }
      let len = this.social.length;
      for (let i = 0; i < len; i++) {
        this.joinCodeList.push(this.storeGoodsList[this.social[i]].storeId);
      }
    ...
    save(item, index) {
      ...
      this.Global.doPost("patrol/displayPictureAudit.json", params, res => {
        this.init();
        this.saveData = {};
    ...
    init() {
      ...
      this.Global.doPost("patrol/displayPictureAutidSingle.json", data, res => {
    ...
    handleLookDetail(val, flag) {
      ...
      queryParams["displayActCategory"] = "patrolsOne";
    ...
    handleIsPass(val) {
      this.activityIsPass = val == "2001" || val == "1" ? false : true;
    },
    ...
    handleBatchSure() {
      ...
      this.Global.doPost(
        "patrol/displayPictureBathAudit.json",
        dataList,
        res => {
