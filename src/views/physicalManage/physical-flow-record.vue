              ...
              <div class="container">
                    ...
                    <div class="btn-left w18">
                        <Form-item  prop="queryStartTime" required>
                            <data-range placeholder="收货开始时间" @dataChange="startTimeChange" hour="00:00" :time="formData.queryStartTime" start></data-range>
                        </Form-item>
                    </div>
                    <div class="btn-left w18">
                        <Form-item  prop="queryEndTime" required>
                            <data-range hour="24:00" placeholder="收货结束时间" @dataChange="endTimeChange" :time="formData.queryEndTime"></data-range>
                        </Form-item>
                    </div>
                    <div class="btn-left w18">
                    <Form-item required>
                        <Select v-model="formData.status" placeholder="*实物流向" clearable>
...
export default {
  name: "participation-details-scan-keepAlive",
  data() {
    return {
      historyShow: false,
      timeModalShow: false,
  ...
  methods: {
    ...
    init(currentPage, pageSize) {
      ...
      this.Global.doPost("report/activityDetailReportNew.json", data, res => {
