  ...
  methods: {
    ...
    changeValue(value) {
      ...
      this.Global.doPost(
        ...
        { date: 15, activityType: 3, scope: "a", brandId: value },
        res => {
          Object.entries(res).forEach(item => {
    ...
    getActivityList(value) {
      ...
      this.Global.doPost(
        ...
        { date: 15, activityType: 3, scope: "a", groupId: value },
        res => {
          Object.entries(res).forEach(item => {
    ...
    handleClearDisplayActivity() {
      ...
      this.Global.doPost("liquidate/doDisplayLiquidate.json", data, res => {
        this.$Message.success("清算中，休息一下稍后查询");
      });
    },
    handleAllAward() {
      if (
