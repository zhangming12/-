...
export default {
  name: "physical-display-granting-details-keepAlive",
  data() {
    return {
      oneLeverList: [], //一级组织数据
      twoLeverList: [], //二级组织数据
                          ...
                          this.Global.doPost(
                            ...
                            res => {
                              ...
                              try {
                                ...
                                params.row.storeId = res.storeId;
  ...
  methods: {
    ...
    init(currentPage, pageSize) {
      ...
      // merchant/entityDetailRecord.json
    ...
    exportExcel() {
      ...
      var url = this.Global.getExportUrl(
        "ecash/ecashDetailExport.json",
        data
      );
      window.open(url);
      // this.Global.doPost("display/discountDetailExport.json", data, res => {
      //   this.myModalisShow = true;
      // });
    },
    changeValue(value) {
