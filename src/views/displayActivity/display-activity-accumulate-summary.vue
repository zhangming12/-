        ...
        <Form ref="form" :model="formData" :label-width="10">
          <div class="container">
            <div class="btn-left w18">
              <Form-item required>
                <data-range placeholder="查询开始时间" hour="00:00" v-model="formData.queryStartTime"></data-range>
              </Form-item>
            </div>
            <div class="btn-left w18">
              <Form-item required>
...
export default {
  ...
  methods: {
    ...
    init(currentPage, pageSize) {
      ...
      this.Global.doPost(
        "displayYxtg/queryDisplayTotalInfo.json",
        data,
        res => {
    ...
    exportExcel() {
      ...
      var url = this.Global.getExportUrl(
        "displayYxtg/queryDisplayTotalInfoExport.json",
        data
      );
      window.open(url);
    },
