    ...
    init(currentPage, pageSize) {
      ...
      this.Global.doPost(
        ...
        res => {
          ...
          let groupAreaInfoList = res.datalist[0].groupAreaInfoList;
          if (groupAreaInfoList) {
            ...
            for (let i = 0; i < res.datalist.length; i++) {
              for (
                let j = 0;
                j < res.datalist[i].groupAreaInfoList.length;
                j++
              ) {
                let index = j + 1;
                ...
                obj[uploadNotPassCount] =
                  res.datalist[i].groupAreaInfoList[j].uploadNotPassCount;
                obj[uploadAuditCount] =
                  res.datalist[i].groupAreaInfoList[j].uploadAuditCount;
                if (res.datalist[i].groupAreaInfoList[j].params) {
                  let params = JSON.parse(
                    res.datalist[i].groupAreaInfoList[j].params
                  ).periodMonthAward;
                  if (params) {
                ...
                obj[displayGroup] =
                  res.datalist[i].groupAreaInfoList[j].displayGroup;
                Object.assign(res.datalist[i], obj);
              }
            }
          }
        }
