...
#Main {
  ...
  height: 100%;
  min-height: 700px;
  background: url("../../assets/presentationBoardImage/1.png");
  // background: #7b1111;
  padding: 0;
  padding-top: 20px;
  overflow: hidden;
  .main-box {
    ...
    .bottomBox {
      ...
      .boxs {
        width: 100%;
        border: 4px solid #b80815;
        box-shadow: inset 0 0 40px #b80815;
        position: relative;
        .left-top-box,
        .left-bottom-box,
        .right-top-box,
...
import sGroup from "@/components/selectGroup.vue";
export default {
