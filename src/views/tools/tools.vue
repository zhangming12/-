              ...
              <div class="modal-table">
                  <Form ref="form" :model="formData" :label-width="88">
                      ...
                      <Form-item label="活动包名">
                        <Select v-model="weeksDate.groupId" placeholder="活动包名" @on-change="getWeexsActivityList" clearable>
                          <Option :value="item.id" v-for="(item,index) in weexsGroupList" :key="index">{{ item.groupName }}</Option>
                        </Select>
                      </Form-item>
                      <Form-item label="活动名称">
                        <Select v-model="weeksDate.activityId" placeholder="活动名称" clearable>
                          <Option :value="item.id" v-for="(item,index) in weexsActivityList" :key="index">{{ item.name }}</Option>
                        </Select>
                      </Form-item>
                      
                      <Form-item label="时间" required >
                        <DatePicker type="date" style="width:100%;" v-model="weeksDate.date" :options="dateOptions" placeholder="选择周期开始时间"></DatePicker>
                      </Form-item>
                      <Form-item label="门店ID" >
            ...
            <div slot="main" class="modal-main">
              ...
              <div class="modal-table">
                  <Form ref="form" :model="hebeiExportData" :label-width="88">
                      ...
                      <Form-item label="客户编号">
                        <Input type="text" clearable v-model.trim="hebeiExportData.joinCode" placeholder="客户编号"></Input>
                      </Form-item>
                      <Form-item label="BAP渠道">
                        <Input type="text" clearable v-model.trim="hebeiExportData.bapChannel" placeholder="BAP渠道"></Input>
                      </Form-item>
                      <Form-item label="销售路线">
                        <Input type="text" clearable v-model.trim="hebeiExportData.salesRoute" placeholder="销售路线"></Input>
                      </Form-item>
                      <Form-item label="销售部">
                        <Input type="text" clearable v-model.trim="hebeiExportData.salesDept" placeholder="销售部"></Input>
                      </Form-item>
                      <Form-item label="销售大区">
                        <Input type="text" clearable v-model.trim="hebeiExportData.salesRegion" placeholder="销售大区"></Input>
                      </Form-item>
                      <Form-item label="营业部">
                        <Input type="text" clearable v-model.trim="hebeiExportData.busiDept" placeholder="营业部"></Input>
                      </Form-item>
                      <Form-item label="办事处">
                        <Input type="text" clearable v-model.trim="hebeiExportData.busiOffice" placeholder="办事处"></Input>
                      </Form-item>
                      <div class="fotter" style="text-align:center;">
                          <Button @click="closeModal" type="primary">取消</Button>
            ...
            <div slot="main" class="modal-main">
              ...
              <div class="modal-table">
                  <Form ref="form" :model="formData" :label-width="88">
                      ...
                      <Form-item label="活动包名" required>
                        <Select v-model="exportExportData.groupId" placeholder="活动包名" @on-change="getExportActivityList" clearable>
                      ...
                      <Form-item label="时间" required >
                        <Row>
                          <Col span="11">
                            <data-range @dataChange="startTimeChange" hour="00:00" :time="exportExportData.queryStartTime"  placeholder="选择开始时间" start></data-range>
                          </Col>
                          <Col span="11" offset="1">
                          <data-range hour="24:00" placeholder="结束时间" @dataChange="endTimeChange" :time="exportExportData.queryEndTime"></data-range>
                          </Col>
                        </Row>
                      </Form-item>
  ...
  methods: {
    ...
    releaseVideo() {
      this.$Modal.confirm({
        ...
        content: "确定释放视频？",
        onOk: () => {
          this.Global.doPost("displayYxtg/deleteVideoOfBeCatch.json", "", res => {
