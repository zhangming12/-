...
export default {
  name: "electronic-voucher-circulation-record-keepAlive",
  data() {
    return {
      historyShow: false,
      timeModalShow: false,
  ...
  methods: {
    ...
    init(currentPage, pageSize) {
      ...
      this.formData["queryStartTime"] ? "" : delete data["queryStartTime"];
      this.formData["queryEndTime"] ? "" : delete data["queryEndTime"];
      data["currentPage"] = this.page;
      data["pageSize"] = this.pageSize;
      this.Global.deleteEmptyProperty(data);
      this.Global.doPost("ecash/ecashCirculateRecord.json", data, res => {
    ...
    exportExcel() {
      ...
      let url = this.Global.getExportUrl(
        "ecash/ecashCirculateRecordExport.json",
        data
      );
      window.open(url);
    },
