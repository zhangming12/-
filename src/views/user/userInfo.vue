  ...
  name:"userInfo-keepAlive",
                                ...
                                on: {
                                    click: () => {
                                        this.$Modal.confirm({
                                            ...
                                            onOk: function(){
                                                that.userBlack(params.row.userId,params.row.brandId,params.row.isBlack)
                                            }
                                        })
                                    }
                                }
                                ...
                                on: {
                                    click: () => {
                                        this.$Modal.confirm({
                                            ...
                                            onOk: function(){
                                                that.userLimit(params.row.userId,params.row.brandId,params.row.isLimit)
                                            }
                                        })
                                    }
                                }
    ...
    methods: {
        ...
        init: function(){
            ...
            this.Global.doPost('report/userInfoDetailReport.json',data,function(res){
        ...
        userBlack: function(userId,brandId,isBlack){
            var that = this;
            var url = '';
            if( isBlack == 0 ){
        ...
        userLimit: function(userId,brandId,isLimit){
            var that = this;
            var url = '';
            if( isLimit == 0 ){
        ...
        showMemo: function(userId,brandId){
            var that = this;
        ...
        getUserMemo: function(userId,brandId){
            var that = this;
            this.Global.doPost('report/brandUserAddMemo.json',{
                userId: userId,
                brandId: brandId,
                memo: this.memo,
                userType: 'B'
        ...
        exportExcel: function(){
            ...
            this.Global.deleteEmptyProperty(data);
             data['userType'] = 'B';
            var url = this.Global.getExportUrl('report/userInfoDetailExport.json',data);
            window.open(url);
        }
    }
}
