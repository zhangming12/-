...
<template>
  <div id="Main">
      <h2 class="Title">河北金银铜活动参与情况统计</h2>
      <div class="box">
...
export default {
  name:"hbGoldActivityPart-keepAlive",
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.Global.Percentage(
                params.row.joinCount,
                params.row.applyCount
              )
            );
          }
        },
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "div",
              this.Global.Percentage(
                params.row.joinCount - params.row.unUploadCount,
                params.row.joinCount
              )
            );
          }
          ...
          render: (h, params) => {
            return h(
              ...
              this.Global.Percentage(
                ...
                params.row.applyCount - params.row.unUploadCount
              )
            );
          }
        },
  ...
  methods: {
    ...
    init: function(currentPage, pageSize) {
      ...
      this.Global.doPost("report/displayActivityJoinReport.json", data, res => {
        this.pageData = res || [];
      });
    },
    ...
    exportExcel: function() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayActivityJoinReportExport.json",
        data
      );
      window.open(url);
    }
