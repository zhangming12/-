...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          minWidth: 100,
          render: (h, params) => {
            return params.row.oldUserCount + params.row.newUserCount;
          }
        }
      ],
      pageData: [],
  ...
  methods: {
    ...
    init: function(currentPage, pageSize) {
      ...
      console.log(data);
      this.Global.doPost("report/displayUserCountReport.json", data, res => {
        this.pageData = res || [];
        // for(let i = 0;i<this.pageData.length;i++){
        // this.pageData[i].createTime = this.formatYearMonth(this.pageData[i].createTime);
        // this.pageData[i].goodsType = this.goodsType(this.pageData[i].goodsType)
        // }
      });
    },
    ...
    exportExcel: function() {
      ...
      var url = this.Global.getExportUrl(
        "report/displayUserCountReportExport.json",
        data
      );
      window.open(url);
    }
