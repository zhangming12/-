      ...
      <div class="box">
            <Form ref="form" :model="formData" :label-width="80">
                ...
                <Row>
                    ...
                    <Col span='2' offset='1' style="position:relative;">
                        <Button @click="submit" type="success" style="margin-left:20px;">查询</Button>
                        <Button @click="showCode" type="info" style="margin-left:20px;margin-top:10px;" v-if="!qrCodeIsShow">查看二维码</Button>
...
export default {
  ...
  methods: {
    ...
    createImage() {
      ...
      let canvasList = img.getElementsByTagName("canvas")[0];
      this.codeUrl = canvasList.toDataURL("image/png");
    },
    downloadCode() {
      window.open(this.codeSrc);
    },
    showCode() {
    ...
    init() {
      ...
      console.log(data);
      this.Global.doPost("brandStaff/queryBrandInsideList.json", data, res => {
