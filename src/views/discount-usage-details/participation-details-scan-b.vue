          ...
          <Form ref="form" :model="formData" :label-width="10">
              ...
              <transition name="fade">
                <div class="container" v-if="showQuery">
                  ...
                  <div class="btn-left w18">
                    <Form-item required>
                        <Input v-model.trim="formData.voucherNo" placeholder="参与流水"></Input>
                    </Form-item>
                  </div>
                  <div class="btn-left w18">
                    <Form-item>
...
export default {
  name: "participation-details-scan-b-keepAlive",
  data() {
    return {
      historyShow: false,
      timeModalShow: false,
                          ...
                          this.Global.doPost(
                            ...
                            res => {
                              ...
                              try {
                                ...
                                params.row.areaAdderss =
                                  params.row.area + params.row.address;
                              } catch (error) {
                                console.error(error);
                              }
  ...
  methods: {
    ...
    changeValue(value) {
      ...
      this.Global.doPostNoLoading(
        ...
        { date: 7, activityType: 1, scope: "a", brandId: value, channel: "B" },
        res => {
          Object.entries(res).forEach(item => {
